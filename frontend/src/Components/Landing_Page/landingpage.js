...
return ( <React.Fragment>
    ...
    <button type="submit" onClick = {this.submitSearch} class="btn btn-lg">Search</button>
        ...
        <ul class="Font_List">
            <li class="Font_Item">
                <strong class="Font_Title">Your hackathon experience starts here</strong><br></br>
                <span class="Font_subTitle">Choose a hackathon from the best options</span>
            </li>
            <li class="Font_Item">
                <strong class="Font_Title">Register and participate with confidence</strong><br></br>
                <span class="Font_subTitle">Secure payments, peace of mind</span>
            </li>
            <li class="Font_Item">
                <strong class="Font_Title">Your code your way</strong><br></br>
                <span class="Font_subTitle">More clarity, more challenges, no compromises</span>
            </li>
        </ul>
        </div>
